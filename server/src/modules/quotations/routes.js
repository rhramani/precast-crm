...
const { createQuotationSchema, updateQuotationSchema, statusSchema, validate } = require('./validation');
...
router.put('/:id',              branchScope, validate(updateQuotationSchema), controller.update);
