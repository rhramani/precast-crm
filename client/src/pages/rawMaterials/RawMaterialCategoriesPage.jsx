...
} from '../../store/api/rawMaterialCategoryApi';
...
const RawMaterialCategoriesPage = () => {
  ...
  // Queries
  const { data, isLoading } = useGetRawMaterialCategoriesQuery({
    page,
    limit,
    search,
    sortBy,
  ...
  // Mutations
  const [createCategory] = useCreateRawMaterialCategoryMutation();
  const [updateCategory] = useUpdateRawMaterialCategoryMutation();
      ...
      >
        ...
        <div className="field-group" style={{ marginBottom: '16px' }}>
          ...
          <input
            ...
            placeholder="e.g. Admixtures, Packaging, Steel Rods"
          />
        ...
        <div className="field-group" style={{ marginBottom: '16px' }}>
          ...
          <textarea
            ...
            placeholder="Describe the usage or type of materials in this category..."
            rows={4}
          />
        </div>
